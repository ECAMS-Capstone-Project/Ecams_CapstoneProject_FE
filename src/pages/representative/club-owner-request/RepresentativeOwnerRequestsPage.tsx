...
import {
  AcceptOrDenyOwnerRequestAPI,
  ClubOwnerChangeResponseDTO,
  GetRequestChangeClubOwnerAPI,
} from "@/api/representative/RequestChangeOwner";
import {
  ArrowLeftIcon,
  ArrowRightIcon,
  ChevronRightIcon,
...
const RepresentativeRequestsPage: React.FC = () => {
  ...
  const [selectedRequest, setSelectedRequest] =
    useState<ClubOwnerChangeResponseDTO | null>(null);
  ...
  const handleReview = (req: ClubOwnerChangeResponseDTO) =>
              ...
              >
                ...
                >
                  <div className="flex items-center gap-3 text-white">
                    <img
                      src="https://cdn-icons-png.flaticon.com/512/3990/3990804.png"
                      className="h-6 w-6"
                      alt="Club"
                    />
