...
import ContractStaffTable from "@/components/partial/staff/staff-contract/ContractStaffTable";

const ContractStaffPage = () => {
    ...
    const loadContract = async () => {
      if (user) {
        try {
          ...
          const contractData = await ContractStaff(pageSize, pageNo, user.staffId);
...
export default ContractStaffPage;
