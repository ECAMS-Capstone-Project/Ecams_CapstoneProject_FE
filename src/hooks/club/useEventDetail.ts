...
import { approveInterEvent, createInterClubEvent, GetEventParticipants, GetInterClubEventDetail, GetInterEvent, GetInterEventRequest, rejectInterEvent } from "@/api/club-owner/ClubEvent";
