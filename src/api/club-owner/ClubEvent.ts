...
export const GetEventParticipants = async (
  ...
  pageSize: number,
  pageNo: number
): Promise<ResponseDTO<ResponseData<Participant>>> => {
  try {
    const response = await get<ResponseDTO<ResponseData<Participant>>>(
      `/Event/participants?EventId=${eventId}&PageNumber=${pageNo}&PageSize=${pageSize}`
    );
...
export const createInterClubEvent = async (
  formData: FormData
): Promise<ResponseDTO<InterClubEvent | string>> => {
  try {
    const response = await axiosMultipartForm.post(
      "/Event/inter-club-event",
      formData
    );
...
export const GetInterEvent = async (
  clubId: string,
  pageSize: number,
  pageNo: number
): Promise<ResponseDTO<ResponseData<InterClubEventDTO>>> => {
  try {
    const response = await get<ResponseDTO<ResponseData<InterClubEventDTO>>>(
      `/InterClub?clubId=${clubId}&PageNumber=${pageNo}&PageSize=${pageSize}`
    );
    return response; // Trả về toàn bộ phản hồi
  } catch (error: any) {
    console.error("Error in UniversityList API call:", error.response || error);
...
export const GetInterEventRequest = async (
  clubId: string,
  pageSize: number,
  pageNo: number
): Promise<ResponseDTO<ResponseData<InterClubEventDTO>>> => {
  try {
    const response = await get<ResponseDTO<ResponseData<InterClubEventDTO>>>(
      `/InterClub?clubId=${clubId}&status=PENDING&PageNumber=${pageNo}&PageSize=${pageSize}`
    );
    return response; // Trả về toàn bộ phản hồi
  } catch (error: any) {
    console.error("Error in UniversityList API call:", error.response || error);
...
export const GetInterClubEventDetail = async (
  eventId: string
): Promise<ResponseDTO<InterClubEventDTO>> => {
  try {
    const response = await get<ResponseDTO<InterClubEventDTO>>(
      `/InterClub/${eventId}`
    );
    return response; // Trả về toàn bộ phản hồi
  } catch (error: any) {
...
export const approveInterEvent = async (
  event: any
): Promise<ResponseDTO<Event>> => {
  try {
    const response = await patch<ResponseDTO<Event>>(
      `/InterClub/accept-inter`,
      event
    );
    return response; // Trả về toàn bộ phản hồi
  } catch (error: any) {
...
export const rejectInterEvent = async (
  event: any
): Promise<ResponseDTO<Event>> => {
  try {
    const response = await patch<ResponseDTO<Event>>(
      `/InterClub/reject-inter`,
      event
    );
    return response; // Trả về toàn bộ phản hồi
  } catch (error: any) {
...
export const endInterEvent = async (
  eventId: string,
  clubId: string
): Promise<ResponseDTO<Event>> => {
  try {
