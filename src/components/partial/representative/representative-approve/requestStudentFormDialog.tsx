                ...
                <form>
                        ...
                        <FormItem>
                          ...
                          <FormControl>
                            <Avatar className="w-20 h-20">
                              <AvatarImage src={initialData?.imageUrl || "https://res.cloudinary.com/ecams/image/upload/v1746281259/%E1%BA%A3nh_fpt_xqriyr.png"} />
                  ...
                  <div className="flex justify-center mt-6">
                    <Avatar className="w-96 h-72 rounded-lg">
                      <AvatarImage
                        src={initialData?.imageUrl || "https://res.cloudinary.com/ecams/image/upload/v1746281259/%E1%BA%A3nh_fpt_xqriyr.png"}
