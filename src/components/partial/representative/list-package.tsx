...
import {
    Box, Button, Card, CardContent, Container, Typography, List,
    ListItem, ListItemIcon, ListItemText, CircularProgress, Alert,
    Chip
} from '@mui/material';
...
const Pricing: React.FC = () => {
    ...
    const handleClick = async (plan: Package) => {
        if (user) {
            const response = await CheckBuyPackageAPI({ packageId: plan.packageId, representativeId: user.representativeId });
