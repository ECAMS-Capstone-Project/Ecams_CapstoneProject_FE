                            ...
                            <CardHeader className="p-0">
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    <p className="text-base text-muted-foreground">
                                        <b>Detail Name:</b>{" "}
                                        <span className="text-foreground">{selectedTask.detailName}</span>
                                    </p>
                                    <p className="text-base text-muted-foreground">
                                        <b>Priority:</b>{" "}
                                        <span className="text-foreground">{selectedTask.priority}</span>
                                    </p>
                                    <p className="text-base text-muted-foreground">
                                        <b>Start Time:</b>{" "}
                                        <span className="text-foreground">{format(selectedTask.startTime, "yyyy-MM-dd - HH:mm")}</span>
                                    </p>
                                    <p className="text-base text-muted-foreground">
                                        <b>Deadline:</b>{" "}
                                    ...
                                    <p className="text-base text-muted-foreground">
                                        <b>Status:</b>{" "}
                                        <span
                                            className={`font-medium ${selectedTask.status === "Completed" ? "text-green-600" :
                                ...
                                <div className="pt-2 text-base text-muted-foreground">
                                    <b>Description:</b>
                                    <p className="mt-1 text-foreground whitespace-pre-line">{selectedTask.description}</p>
                                </div>
                            </CardHeader>
                        </Card>
                    )}
