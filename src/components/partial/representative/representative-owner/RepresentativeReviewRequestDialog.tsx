      ...
      <Card className="max-w-2xl w-full rounded-xl shadow-xl">
        ...
        <CardContent className="p-6 space-y-6">
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
            ...
            {/* Requested Candidate */}
            <div className="flex items-center justify-between gap-4 bg-gradient-to-r from-[#136CB9]/10 to-[#49BBBD]/10 p-3 rounded-lg">
              <div className="flex items-center gap-4">
                <UserCircleIcon className="h-8 w-8 text-[#136CB5]" />
                <div>
                  <p className="text-sm text-[#136CB5]">Requested Candidate</p>
                  <p className="font-medium text-[#136CB5]">
                    {request.requestedPerson?.fullname}
                  </p>
                  <p className="text-xs text-[#136CB5]">
                    {request.requestedPerson?.email}
                  </p>
                </div>
              </div>
              <EyeIcon
                className="w-5 h-5 text-[#136CB5] cursor-pointer hover:text-[#136CB5]"
                onClick={() =>
                  setViewingUser({
            ...
            <div className="flex gap-4">
              ...
              <Button
                ...
                className={`px-6 py-2.5 rounded-lg text-sm font-semibold transition-all duration-200 
                                            ${
                                              decision === "deny"
                                                ? "bg-red-400 text-white shadow-md hover:bg-red-400"
              ...
              <div className="flex flex-col items-center w-full sm:w-1/3">
                <img
                  src={
                    ...
                    `https://api.dicebear.com/6.x/initials/svg?seed=${viewingUser.user.fullname}`
                  }
