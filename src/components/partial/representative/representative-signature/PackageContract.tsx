    ...
    >
      ...
      >
        <CardContent>
          ...
          <List>
            <ListItem>
              <b>Article 1: Contract Content</b>
            </ListItem>
            <ListItem>
              <span>
            ...
            <ListItem>
              <b>Article 2: Rights and Responsibilities</b>
            </ListItem>
            <ListItem>
              ✅ Party B has the right to use premium service features.
            </ListItem>
            <ListItem>
              ✅ Party A is responsible for maintaining stable service
              operations.
            </ListItem>
            <ListItem>
              <span>
                ✅ Party B is responsible for full payment of{" "}
                <b>{formatPrice(selectedPlan?.price)}</b>.
              </span>
            </ListItem>

            <ListItem>
              <b>Article 3: Payment Terms</b>
            </ListItem>
            <ListItem>
              💰 Party B shall make payments through supported methods.
            </ListItem>
            <ListItem>
              💰 Party A will suspend the service if Party B fails to make
              timely payments.
            </ListItem>

            <ListItem>
              <b>Article 4: Contract Cancellation Policy</b>
            </ListItem>
            <ListItem>
              🚫 Party B may request contract cancellation but will not receive
              a refund.
            </ListItem>
