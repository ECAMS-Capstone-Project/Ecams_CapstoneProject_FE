...
import ActiveMemberList from "./club-active-table/ActiveMemberList";
import RepEventList from "./RepEventList";

export default function RepClubDetailPage() {
    ...
    <div className="max-w-[1700px] mx-auto p-4 pt-0">
      ...
      <Tabs defaultValue="members" className="w-full">
        ...
        <TabsContent value="events">
          <RepEventList clubId={clubId} isClubOwner={isClubOwner} />
        </TabsContent>
