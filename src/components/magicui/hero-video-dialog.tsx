...
export default function HeroVideoDialog({
  ...
  const [, setIsVideoOpen] = useState(false);
    ...
    <div className={cn("relative", className)}>
      ...
      >
        <img
          ...
          width={1920}
          height={1080}
          className="w-full rounded-md border border-slate-200 shadow-lg transition-all duration-200 ease-out group-hover:brightness-[0.8] dark:border-slate-800"
        />
          ...
          >
            ...
            >
              <motion.button className="absolute -top-16 right-0 rounded-full bg-neutral-900/50 p-2 text-xl text-white ring-1 backdrop-blur-md dark:bg-neutral-100/50 dark:text-black">
                <XIcon onClick={() => setIsOpen(false)} className="size-5" />
              </motion.button>
